...
SCORECARD_PROJECT_ID = os.getenv("SCORECARD_PROJECT_ID")

ANTHROPIC_API_KEY = os.getenv("ANTHROPIC_API_KEY")
MODEL = "claude-haiku-4-5"

if not SCORECARD_API_KEY:
    raise ValueError("SCORECARD_API_KEY is not set")
if not ANTHROPIC_API_KEY:
    raise ValueError("ANTHROPIC_API_KEY is not set")
if not SCORECARD_PROJECT_ID:
    raise ValueError("SCORECARD_PROJECT_ID is not set")
